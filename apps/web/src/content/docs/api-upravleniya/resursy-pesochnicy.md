...
которые сохраняются этим же маршрутом. А вот завести вторую песочницу, сменить
объём данных или удалить песочницу можно только отсюда: в кабинете этих операций
нет вовсе.
