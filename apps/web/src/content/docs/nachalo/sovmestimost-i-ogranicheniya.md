...
(по умолчанию 250 мс) и доля случайных ошибок (по умолчанию 5 %) не измеряют
ничего: это регуляторы, которыми вы проверяете свой код. К скорости боевых
сервисов они отношения не имеют.
