---
title: Свои моки
description: Свой путь, метод, код и тело ответа с плейсхолдерами — эндпоинты, которых нет ни у одного из сервисов стенда.
order: 500
group: Кабинет
---

Мок-шлюз повторяет Bitrix24, Ozon, Wildberries и Apify. Если разрабатываемому коду нужен
